		...
		<>
			...
			>
				<div className={buttonGroup}>
					<a
						href='https://github.com/cottons-kr/sotto-app/releases/download/1.2.1/Sotto-Android.zip'
						rel='noopener noreferrer'
					>
						<Button>Android (.apk)</Button>
					</a>
					<a
						href='https://github.com/cottons-kr/sotto-app/releases/download/1.2.1/Sotto-iOS-Simulator.zip'
						rel='noopener noreferrer'
					>
